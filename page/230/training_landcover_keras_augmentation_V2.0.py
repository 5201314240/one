...
import random
import os
# os.environ["SM_FRAMEWORK"] = "tensorflow.tf.keras"
...
# 读取一张图片进行展示
########################################################################
train_img_dir = "data/data_for_training_and_testing/train/images/"
train_mask_dir = "data/data_for_training_and_testing/train/masks/"
